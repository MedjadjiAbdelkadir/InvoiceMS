				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo.svg')}}" class="logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo-white.png')}}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/favicon.svg')}}" class="logo-2" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/favicon.svg')}}" class="dark-logo-2" alt="logo"></a>
						</div>
					...
					<div class="main-header-right">
							...
							{{-- <li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<button id="btn-toggle-theme">
										<i class="fa-solid fa-2x nav-li-icon-bottom" id="icon"></i>
									</button>
								</div>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							{{-- <div class="nav-item btn" > --}}
								...
								<button class="nav-item btn" id="btn-toggle-theme">
									<i class="fa-solid fa-2x nav-li-icon-bottom" id="icon"></i>
								</button>
							{{-- </div> --}}
